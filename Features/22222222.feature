Feature: 1233. erttertreValidate Presence of all elements
  ...
  @test2
  Scenario: rttryrtyinvalValidate all fields,checkboxes, radio buttons, Submit button and hyperlinks are appearing on the page.
    Then Verify following are appearing on the page or not
      | Fields              |
      | Text input          |
      | Password            |
  ...
  @test3 @Smoke
  Scenario: xcvxcvinsdfsdfsdfsdfvalValidate all fields,checkboxes, radio buttons, Submit button and hyperlinks are appearing on the page.
    Then Verify following are appearing on the page or not
      | Fields              |
      | Text input          |
      | Password            |
